  ...
  public render() {
    ...
    return (
      <div>
        ...
        <h3>BracketGame</h3>
        <p>
          The core element in rendering the data is the <code>BracketGame</code> component
        </p>
        <GameComponent game={ROOT} homeOnTop={homeOnTopState} />

        <h3>Bracket</h3>
        <p>
          The bracket is rendered using a <code>Bracket</code> component, which takes the final game of the bracket. The game shape is a graph, so a single game
          should contain all the information required to render the bracket.
        </p>
        ...
        <p>
          ...
          <code>Bracket</code> for each root game. It also places each <code>Bracket</code> in mobile friendly parent <code>div</code>s and synchronizes the
          highlighted teams across brackets.
        </p>
